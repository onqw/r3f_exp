  ...
  float cnoise(vec4 P){
    ...
    //   uniform vec2 uMouse;
      ...
      void main() {
        ...
        vec3 noise2 = 1.*(position + time *vec3(0., 0.1, 0.)) * vec3(5.,1.,1.);
    ...
    //   uniform float time;
      ...
      void main() {
        ...
        float alpha = 1. - smoothstep(0.45, 0.5, dist);
          ...
          gl_FragColor = vec4(1., 1., 1.0 , alpha*0.5 + 0.5*vProgress);
      }
      `,
  // sometimes particles dissapear depending on the angle, which depthWrite,
  // depthTest and transparent improves
  depthWrite: false,
  depthTest: false,
  transparent: true,
